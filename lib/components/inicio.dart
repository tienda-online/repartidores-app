  ...
  BottomNavigationBar buildNavBar(){
    return BottomNavigationBar(
      ...
      items: [
        ...
        BottomNavigationBarItem(icon: Icon(Icons.drive_eta_outlined),title: Text("Pedidos")),
        BottomNavigationBarItem(icon: Icon(Icons.bike_scooter),title: Text("Pedido Actual")),
      ],
