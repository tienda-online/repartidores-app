...
class _ChatState extends State<Chat> {
  ...
  void initState() {
    this.getMensajesNow();
    Timer.periodic(Duration(seconds: 5),getMensajes);
    super.initState();
  }
  @override
                          ...
                          Flexible(
                            ...
                            child: Container(
                              child: FormInput(
                                ...
                                isContrasena: false,onSubmit: (string) async{
                                  Respuesta respuesta= await RequestService.createMensaje(widget.ordenActual.codigoOrden, mensajeController.text);
          ...
          child: Row(children: [
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image:  DecorationImage(
                  image: NetworkImage(widget.ordenActual.cliente.imagen),
                  fit: BoxFit.cover  
                )
                ),
            ...
            Padding(
              ...
              child: Column(
                ...
                Padding(
                  padding:EdgeInsets.only(top:getProportionateScreenHeight(20)),
                  child: Text("${widget.ordenActual.cliente.nombre} ${widget.ordenActual.cliente.apellido}",
                    style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: getProportionateScreenHeight(20)),),
                ),
                Text(widget.ordenActual.cliente.direccion.direccion,style: TextStyle(fontSize: getProportionateScreenHeight(15)),)
              ],),
            )
          ],),
        )
  ...
  void getMensajes(Timer timer) async{
     Respuesta respuesta= await RequestService.getMensajesOrden(widget.ordenActual.codigoOrden);
     if(respuesta.error=="true"){
       return;
     }else{
       List<Mensaje> mensajes=[];
